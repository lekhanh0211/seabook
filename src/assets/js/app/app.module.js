(function () {
    ...
    var app = angular.module('uiApp', [
        ...
        var urlApp = $('input[name="sys-urlApi"]').val();
        return {
            request: function (config) {
                ...
                var vUrl = config.url;
                if (vUrl && /^\/(api)/.test(vUrl)) {
                    config.url = urlApp + vUrl;
                } else if (vUrl && (
                    // html bắt đầu với `assets/partials` là static files của dự án
                    (vUrl.endsWith('.html') && /^\/(assets)/.test(vUrl))
        ...
        $rootScope.UrlApp = $('input[name="sys-urlApp"]').val();
        $rootScope.UrlApi = $('input[name="sys-urlApi"]').val();
        ...
        $rootScope.$on('$stateChangeSuccess', () => setTimeout(() => stopLoader2(), 500));
    ...
    function ($locationProvider, $stateProvider, $urlRouterProvider, $httpProvider) {
        ...
        $stateProvider.state('Shop', {
            url: '/Shop?s&id&order',
            templateUrl: 'assets/partials/Shop.html',
            controller: 'ShopCtrl'
        })
        ...
        $stateProvider.state('Wishlist', {
            url: '/Wishlist',
            templateUrl: 'assets/partials/Wishlist.html',
        ...
        $stateProvider.state('LichSuMuaHang', {
            ...
            templateUrl: 'assets/partials/LichSuMuaHang.html',
            controller: 'LichSuMuaHangCtrl'
        })
        $stateProvider.state('CTDonHang', {
            url: '/CTDonHang?id',
            templateUrl: 'assets/partials/CTDonHang.html',
        ...
        $stateProvider.state('GioiThieu', {
            url: '/GioiThieu/:id',
            templateUrl: 'assets/partials/GioiThieu.html',
            controller: 'GioiThieuCtrl'
        })
        .state('notfound', {
            url: '/not-found?url',
            templateUrl: 'assets/partials/notfound.html',
            controller: ['$scope', function ($scope) {
